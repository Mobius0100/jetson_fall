...
class Track:
    def __init__(self, mean, covariance, track_id, n_init, max_age=30, buffer=50):
        self.mean = mean
    ...
    def update(self, kf, detection):
        ...
        print(f'tracker kpt length: {len(self.keypoints_list)}')
        self.hist += 1
        self.time_since_update = 0
...
class Tracker:
    def __init__(self, max_iou_distance=0.7, max_age=30, n_init=5, buffer=100):
    ...
    def update(self, detections):
        ...
        print(f'Match result: \n length: {len(matches)}, {len(unmatched_tracks)}, {len(unmatched_detections)} \n Matches: {matches}')
    ...
    def _initiate_track(self, detection):
        ...
        self.tracks.append(Track(mean, covariance, self._next_id, self.n_init, self.max_age, self.buffer))
        self._next_id += 1